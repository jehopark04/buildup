...
export const activityCatalog: Activity[] = defineActivityCatalog([
  ...
  },
  {
    ...
    sourceHint: "공개SW 포털 아카데미 소개",
    sourceName: "공개SW 포털 오픈소스 컨트리뷰션 아카데미",
    sourceUrl: "https://www.oss.kr/academy/introduce/show/44f8e6f7-4f0b-4f3a-b857-e66070f5f3f5",
  ...
  },
  {
    ...
    sourceHint: "공개SW 포털 개발자대회",
    sourceName: "오픈소스 개발자대회",
    sourceUrl: "https://www.oss.kr/dev_competition",
    recruitmentStatus: "upcoming",
