...
export const activityCatalog: Activity[] = defineActivityCatalog([
  {
    ...
    scheduleText: "학생 참여 활동 게시판 최신 공지 수시 확인",
  ...
  },
  {
    ...
    nextStep:
      "학기 시작 전후 AI융합대학 산학협력 프로젝트 공지를 확인하고, 요구 기술 스택을 먼저 체크하세요.",
    sourceHint: "AI융합대학 산학협력 프로젝트 안내",
    sourceName: "한국항공대학교 AI융합대학 산학협력 프로젝트",
    sourceUrl: "http://aisw.kau.ac.kr/pages/project.php",
    recruitmentStatus: "rolling",
    scheduleText: "최근 2025학년도 2학기 선발 결과 게시, 차기 학기 공고 확인 권장",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: true,
  ...
  },
  {
    ...
    sourceHint: "AI융합대학 인턴십 프로그램, 대학일자리플러스센터",
    sourceName: "한국항공대학교 AI융합대학 인턴십 프로그램",
    sourceUrl: "http://aisw.kau.ac.kr/pages/internship.php",
    recruitmentStatus: "rolling",
    scheduleText: "방학·학기 현장실습 선발 결과와 차기 모집 공지 확인",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: true,
    tracks: ["frontend", "backend", "product", "design", "ai"],
    grades: ["junior", "senior"],
  ...
  },
  {
    ...
    sourceUrl: "http://aisw.kau.ac.kr/pages/student_02.php?code=s7201",
    recruitmentStatus: "rolling",
    scheduleText: "학생 참여 활동 게시판에서 프로젝트형 공고 수시 확인",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: true,
  ...
  {
    id: "kau-ict-drone-makerthon-2026",
    title: "2026 KAU ICT(항공드론) 창업메이커톤",
    category: "교내 활동",
    summary:
      "스마트 ICT 디바이스와 항공드론 기술을 활용해 사회문제 해결형 시제품을 만드는 교내 창업 메이커톤입니다.",
    details:
      "아이디어 기획, 팀 빌딩, 시제품 제작, 발표 평가까지 이어지는 활동이라 개발, AI, 기획, 디자인 직무 모두에게 실전 산출물을 만들기 좋습니다. 3D프린터, 레이저커팅기, 오픈소스 하드웨어 기반 제작과 전문가 멘토링이 포함됩니다.",
    cadence: "2026학년도 상반기 모집",
    estimatedTime: "2026.03.24~05.16, 선발 후 집중 제작",
    timeBasis:
      "대학일자리플러스센터 상세 공고 기준 참가신청은 2026년 4월 13일 15시까지이며, 최종 메이커톤 및 평가는 2026년 5월 15일부터 16일까지 진행됩니다.",
    nextStep:
      "4월 13일 15시 전까지 팀 구성과 참가계획서를 먼저 정리하고, 대학일자리플러스센터에서 신규팀 개설 또는 팀원 신청을 진행하세요.",
    sourceHint: "대학일자리플러스센터 창업 프로그램",
    sourceName: "한국항공대학교 대학일자리플러스센터 창업메이커톤",
    sourceUrl: "https://career.kau.ac.kr/ko/program/startup/view/2319",
    recruitmentStatus: "open",
    scheduleText:
      "참가신청 2026.03.24~2026.04.13 15시, 메이커톤 2026.05.15~05.16",
    deadlineText: "2026년 4월 13일 15시",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: true,
    tracks: ["frontend", "backend", "product", "design", "ai"],
    grades: ["freshman", "sophomore", "junior", "senior"],
    levels: ["basic", "project", "ready"],
    activityTypes: ["project", "contest"],
  },
  {
  ...
  },
  {
    ...
    scheduleText: "2025년 과정 안내 기준, 2026년 차기 모집 공지 대기",
    deadlineText: "공개SW 포털 차기 모집 공고 확인",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
  ...
  },
  {
    ...
    recruitmentStatus: "upcoming",
    scheduleText: "직전 10기 일정 종료, 차기 기수 모집 가이드 대기",
    deadlineText: "직전 10기 접수 마감: 2025년 6월 9일 11시",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
  ...
  },
  {
    ...
    recruitmentStatus: "upcoming",
    scheduleText: "직전 8기 교육 종료, 차기 기수 모집 가이드 대기",
    deadlineText: "직전 8기 접수 마감: 2025년 8월 14일 11시",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
    tracks: ["backend", "ai"],
    grades: ["junior", "senior"],
  ...
  },
  {
    ...
    recruitmentStatus: "rolling",
    scheduleText: "SSAFY On 상시등록 및 차기 정규 기수 모집 공지 확인",
    deadlineText: "정규 기수 모집은 SSAFY 공식 공지 확인",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
    tracks: ["frontend", "backend", "ai"],
    grades: ["senior"],
  ...
  },
  {
    ...
    recruitmentStatus: "upcoming",
    scheduleText: "직전 37기 모집·활동 일정 게시, 차기 기수 모집 공지 대기",
    deadlineText: "직전 37기 서류 지원: 2025년 7월 30일~8월 13일 23:59",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
    tracks: ["frontend", "backend", "product", "design"],
    grades: ["sophomore", "junior", "senior"],
  ...
  },
  {
    ...
    sourceUrl: "https://www.kmooc.kr/view/course/detail/19479",
    recruitmentStatus: "open",
    scheduleText: "수강신청 2026.02.27~2026.04.17, 운영 2026.03.02~2026.06.15",
    deadlineText: "2026년 4월 17일",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
    tracks: ["backend", "ai"],
    grades: ["freshman", "sophomore", "junior", "senior"],
  ...
  },
  {
    ...
    sourceUrl: "https://www.kmooc.kr/view/course/detail/19395",
    recruitmentStatus: "open",
    scheduleText: "수강신청 2026.03.03~2026.05.06, 운영 2026.03.10~2026.06.22",
    deadlineText: "2026년 5월 6일",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
  ...
  },
  {
    ...
    title: "공공데이터·AI 활용 창업경진대회",
    category: "공모전",
    summary:
      "공공데이터와 AI를 활용해 문제를 정의하고 서비스 아이디어나 시제품을 만드는 공모전형 카드입니다.",
    details:
      "데이터 활용, 제품 기획, 서비스 구현을 한 번에 묶을 수 있어 백엔드, AI, PM 직무에 특히 좋습니다. 기관별 예선을 거쳐 통합본선으로 이어지는 구조라 프로젝트 경험이 조금 있는 뒤에 나가는 편이 결과물 완성도가 높습니다.",
    cadence: "연례 운영",
    ...
    sourceName: "범정부 공공데이터·AI 활용 창업경진대회",
    sourceUrl: "https://www.data.go.kr/suc/startup.do",
    recruitmentStatus: "upcoming",
    scheduleText: "제14회 공식 안내 게시, 기관별 예선 공고와 통합본선 일정 확인",
    deadlineText: "기관별 예선 접수 일정 확인",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
  ...
  },
  {
    ...
    recruitmentStatus: "upcoming",
    scheduleText: "2025년 대회 접수 종료, 2026년 차기 대회 공지 대기",
    deadlineText: "직전 대회 접수: 2025년 5월 20일~6월 30일",
    lastVerifiedAt: "2026-04-10",
    isKauInternal: false,
    tracks: ["frontend", "backend", "ai"],
    grades: ["sophomore", "junior", "senior"],
